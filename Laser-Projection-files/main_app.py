"""
main_app.py - Original headless runtime entrypoint logic (moved from Main.py).

This module exists so Main.py can become a small GUI launcher while preserving
the original runtime behavior when you choose "Run main" in the launcher.
"""
